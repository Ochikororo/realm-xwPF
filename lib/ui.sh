...
download_realm_ocr_script() {
    local script_url="https://raw.githubusercontent.com/Today-to-Lsp/realm-xwPF/main/xw_realm_OCR.sh"
...
download_failover_script() {
    local script_url="https://raw.githubusercontent.com/Today-to-Lsp/realm-xwPF/main/xwFailover.sh"
...
port_traffic_dog_menu() {
    local script_url="https://raw.githubusercontent.com/Today-to-Lsp/realm-xwPF/main/port-traffic-dog.sh"
